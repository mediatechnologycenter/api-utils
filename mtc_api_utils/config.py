...
class Config(ConfigBuilder):
    ...
    # PolyBox
    polybox_usr = ConfigBuilder.parse_env_var("POLYBOX_USR", default="")
    polybox_pwd = ConfigBuilder.parse_env_var("POLYBOX_PWD", default="")
    ...
    firebase_auth_service_account_url = ConfigBuilder.parse_env_var("FIREBASE_AUTH_SERVICE_ACCOUNT_CREDENTIALS_URL", default="", )
